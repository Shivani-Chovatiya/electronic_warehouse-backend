...
//	public Product(long id, String name, String image, String description, String rating, float price,
...
public Product2(long id, String name, String sellerid, String image, String description, String rating, float price,
			int cis, String reveiws, Date createdAt, String gst, String discount, String catagory) {
		super();
		this.id = id;
		this.name = name;
